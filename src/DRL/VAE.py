...
class CVAE(tf.keras.Model):
    ...
    def __init__(self, latent_dim):
        ...
        self.encoder = tf.keras.Sequential(
            [
                tf.keras.layers.InputLayer(input_shape=(1, 128, 1)),
                tf.keras.layers.Conv1D(
                    filters=32, kernel_size=1, activation='relu', input_shape=(1, 128, 1)),
                tf.keras.layers.Conv1D(
        ...
        self.decoder = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Dense(units=32 * 8, activation=tf.nn.relu),
                tf.keras.layers.Reshape(target_shape=(32, 8)),
